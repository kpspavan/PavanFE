...
const Tools = () => {
  const tech = [
    ...
    { id: 3, src: vscode, title: "VisualStudioCode", style: "shadow-orange-300" },
  ...
  return (
    <div name="experience" className=" py-8">
      <div className="max-w-screen-lg mx-auto p-4 text-white">
        <h1 className="text-4xl text-black font-bold border-b-4 flex justify-center border-gray-500 mb-6">Tools</h1>
        <p className="text-center text-lg mb-12">These are the Few Tools I have worked with</p>
